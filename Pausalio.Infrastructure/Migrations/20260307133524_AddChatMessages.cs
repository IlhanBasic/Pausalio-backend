        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_BusinessProfiles_BusinessProfileId",
                        column: x => x.BusinessProfileId,
                        principalTable: "BusinessProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatMessages_UserProfiles_ReceiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_BusinessProfileId",
                table: "ChatMessages",
                column: "BusinessProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_ReceiverId_BusinessProfileId_Status",
                table: "ChatMessages",
                columns: new[] { "ReceiverId", "BusinessProfileId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_SenderId_ReceiverId_BusinessProfileId",
                table: "ChatMessages",
                columns: new[] { "SenderId", "ReceiverId", "BusinessProfileId" });
