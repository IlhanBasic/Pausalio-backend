...
namespace Pausalio.Infrastructure.Migrations
{
    ...
    [Migration("20260724183427_AddedTablesForAiMessages")]
    partial class AddedTablesForAiMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.AiConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.AiMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.AiToolCall", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("ReceiverId", "BusinessProfileId", "Status");

                    b.HasIndex("SenderId", "ReceiverId", "BusinessProfileId");
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.Client", b =>
                {
                    ...
                    b.HasIndex("Email", "BusinessProfileId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.AiMessage", b =>
                {
                    b.HasOne("Pausalio.Domain.Entities.AiConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.AiToolCall", b =>
                {
                    b.HasOne("Pausalio.Domain.Entities.AiMessage", "Message")
                        .WithMany("ToolCalls")
            ...
            modelBuilder.Entity("Pausalio.Domain.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasOne("Pausalio.Domain.Entities.UserProfile", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Pausalio.Domain.Entities.UserProfile", "Sender")
                        .WithMany()
